...
export default function DependencyMap({
  ...
  return (
    <div className="space-y-6 text-left">
      ...
      <div className="p-6 bg-slate-50/40 border border-slate-250/50 rounded-2xl min-h-[500px] flex flex-col justify-start relative overflow-hidden backdrop-blur-xs">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_120px_1fr_100px] items-center gap-2 relative z-10">
          ...
          <div className="space-y-4 flex flex-col justify-center h-full">
            ...
            {isL3MatchesFilters ? (
              <div 
                onClick={() => setActiveCard(activeCard === 'l3' ? null : 'l3')}
              ...
              <div className="py-12 border border-dashed border-slate-200 text-center text-xs text-slate-405 italic rounded-xl bg-white/40">
          ...
          <div className="space-y-6 flex flex-col justify-around h-full">
            ...
            <div className="space-y-4">
              ...
              {isL2UpperMatchesFilters ? (
                <div 
                  onClick={() => setActiveCard(activeCard === 'l2_upper' ? null : 'l2_upper')}
                  className={`p-4 bg-white rounded-xl border transition-all cursor-pointer relative shadow-sm hover:translate-y-[-1px] hover:shadow-md ${
              ...
              {isL2LowerMatchesFilters ? (
                <div 
                  onClick={() => setActiveCard(activeCard === 'l2_lower' ? null : 'l2_lower')}
