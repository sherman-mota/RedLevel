...
const ptBR: Translations = {
  ...
  settingsSubtitle: 'Configure o servidor do redmine e seus mapeamentos.',

  section1Title: 'Conexão com o Servidor do Redmine',
  labelServerUrl: 'URL do Servidor Redmine',
  ...
  section3Title: 'Mapeador de Tipo de Tarefa vs Nível de Gestão',
  ...
  trackersDescription: 'Associe cada Tipo de Tarefa (Tracker) do seu Redmine ao seu respectivo nível de gestão. Isso ditará em quais quadros e visões cada tarefa será agrupada.',
  ...
  levelStrategic: 'Nível 3 - Estratégico',
  levelTactical: 'Nível 2 - Tático',
  levelOperational: 'Nível 1 - Operacional',
  levelIgnore: 'Ignorar',
  addCustomTracker: 'Adicionar Rastreador Personalizado Manualmente',
  placeholderCustomTracker: 'Ex: Epic, Sub-tarefa',

  section5Title: 'Mapeamento de status das tarefas vs Estágios do Kanban',
  ...
  section2Title: 'Aparência & Idiomas',
